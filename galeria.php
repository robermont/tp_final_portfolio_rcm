...
<div class="row d-flex justify-content-center mb-5">
    <div class="col-md-10 col-sm-12">
        <div class="card bg-dark bg-opacity-75 formCard">
            <div class="card-header text-white fs-5 text-center">
                Datos del Proyecto
            </div>
            <div class="card-body text-white formCard">
...
<div style="background-color:#CDB3A6;">
    <div class="row d-flex justify-content-center mb-5 bg-dark">
        <div class="col-md-10 col-sm-6 bg-secondary bg-gradient">
            <table class="table tabla__galeria bg-success p-2 text-dark bg-opacity-25 text-white">
                <thead>
                    <tr>
                        <th>Nombre</th>
                        <th>Imagen</th>
            ...
            <h2 class="card-title text-white card__mobile fs-4">Listado de proyectos ingresados: </h2>
            <?php #leemos proyectos 1 por 1
                 foreach($proyectos as $proyecto){ ?>
                    <div class="col card__mobile  mb-4">
                        <div class="card border border-3 shadow w-100 bg-secondary bg-gradient">
                            <h3 class="card-title text-white fs-5"><?php echo $proyecto['nombre'];?></h3>
                            <a>
                                <img class="card-img-top" width="200" src="imagenes/<?php echo $proyecto['imagen'];?>" alt="">
                            </a>
                            <div class="card-body">
                               
                                <p class="card-text text-white"><?php echo $proyecto['descripcion'];?></p>
